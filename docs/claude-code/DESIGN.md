...
>
> Vendored from https://github.com/cola-runner/awesome-tui-design/blob/master/designs/claude-code/DESIGN.md so zua sessions can reference it offline. zua adopts this design language through its 16-color ANSI palette (see DESIGN.md at the repo root for zua-specific decisions and deviations).
